...
export default function OttersHomeProject() {
  ...
  return (
    <main ref={containerRef} className="relative min-h-screen bg-black text-zinc-300 font-sans selection:bg-emerald-500/30 selection:text-emerald-100">
      ...
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-8 h-24 bg-gradient-to-b from-black/80 to-transparent pointer-events-none">
        <Link href="/" className="pointer-events-auto group flex items-center gap-3 px-6 py-3 rounded-full bg-zinc-900/50 backdrop-blur-md border border-white/10 hover:border-white/30 transition-all relative z-50">
          <ArrowLeft className="w-5 h-5 text-zinc-400 group-hover:text-white transition-colors" />
          <span className="text-sm font-bold tracking-widest text-zinc-400 group-hover:text-white transition-colors">返回首页</span>
        </Link>
      </nav>
